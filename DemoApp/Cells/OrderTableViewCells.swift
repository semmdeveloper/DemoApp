...
protocol ProdCellDelegate {
    func increaseNumber(cell: ProdCell,number : Int)
    func decreaseNumber(cell: ProdCell,number : Int)
}
...
class ProdCell : UITableViewCell {
    ...
    var prod : Prod? {
        didSet {
            ...
            let myView=UIView(frame: CGRect(x: 40 , y: 330, width: UIScreen.main.bounds.width*0.8, height: UIScreen.main.bounds.height*0.1));
            myView.backgroundColor = Utils.tabViewColor
